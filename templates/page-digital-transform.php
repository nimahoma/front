			...
			<div class="container">
				<div class="page-wrapper Internal-pages" id="digital-transform">
					<aside class="page-sticky-sidebar">
						...
						>
							<a
								...
								href="#solutions-1"
								data-target="#solutions-1"
								>راهکارها</a
							>
							<a
								class="sa-ss-nav-item"
								href="#consulting-2"
								data-target="#consulting-2"
								>مشاوره</a
							>
							<a
								class="sa-ss-nav-item"
					...
					<div class="page-content-wrapper">
						<section
							class="section-scroll solutions page-section-bottom"
							id="solutions-1"
						>
						...
						<section
							class="section-scroll consulting page-section-bottom page-section-top"
							id="consulting-2"
						>
						...
						<section
							class="section-scroll products page-section-bottom page-section-top"
							id="products-3"
						>
							<div class="sa-paragraph-box">
								<div class="title">
