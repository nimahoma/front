		...
		<div class="page-wrapper Internal-pages" id="digital-transform">
			<aside class="page-sticky-sidebar">
				<div class="sa-scrollspy-nav" id="sa-scrollspy-nav">
					<a class="sa-ss-nav-item" href="#solutions-1"
						>راهکارها</a
					>
					<a class="sa-ss-nav-item" href="#consulting-2"
						>مشاوره</a
					>
					<a class="sa-ss-nav-item" href="#products-3"
						>خدمات</a
					>
					<a class="sa-ss-nav-item" href="#case-study-4"
						>بررسی موردی</a
					>
				</div>
			</aside>
			...
			>
				<section
					class="solutions page-section-bottom page-section-top"
					id="solutions-1"
				>
				...
				<section
					class="consulting page-section-bottom page-section-top"
					id="consulting-2"
				>
					<div class="sa-paragraph-box">
						<div class="title">
				...
				<section
					class="products page-section-bottom page-section-top"
					id="products-3"
				>
					<div class="sa-paragraph-box">
						<div class="title">
				...
				<section
					class="case-study page-section-top"
					id="case-study-4"
				>
